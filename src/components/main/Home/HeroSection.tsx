    ...
    >
      <div className="flex h-full flex-col gap-6 p-3">
        ...
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center md:gap-8 lg:mb-10 xl:mb-24">
          ...
          <Button
            variant="outline"
            className="dark:text-foreground dark:border-foreground border-background text-background before:bg-background hover:text-foreground hover:border-background relative z-10 flex max-h-40 w-full items-center justify-center overflow-hidden border-2 text-sm before:absolute before:top-0 before:-z-10 before:h-full before:w-full before:-translate-x-[100%] before:transition-all before:duration-500 before:ease-out before:content-[''] hover:scale-100 hover:before:translate-x-0 sm:w-fit"
          >
            <HiOutlineHome
              size={20}
              strokeWidth={2}
