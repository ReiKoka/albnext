...
function SinglePhoto({ flex, text, imageUrl, marginTop }: SinglePhotoProps) {
  return (
    <div
    ...
    >
      ...
      <div className="absolute top-0 left-0 flex h-full w-full items-center justify-center">
        <h1
          className={`font-primary text-background dark:text-foreground text-4xl font-bold ${marginTop} capitalize`}
        >
          {text}
        </h1>
      </div>
