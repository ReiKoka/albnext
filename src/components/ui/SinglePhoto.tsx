...
function SinglePhoto({ flex, text, imageUrl }: SinglePhotoProps) {
  return (
    ...
    >
      <div className="absolute top-0 left-0 h-full w-full rounded-4xl bg-black opacity-25"></div>
      <div className="absolute top-0 left-0 flex h-full w-full items-center justify-center">
        <h1 className="font-primary text-background dark:text-foreground text-4xl font-bold capitalize">
          {text}
        </h1>
      </div>
    </div>
